...
import { Search, ShoppingCart, User, Menu, X, LayoutDashboard, Heart, Gift } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-18">
            ...
            <div className="flex items-center space-x-1 lg:space-x-3">
              {/* Customized Hamper Button - Desktop */}
              <button
                className="hidden lg:flex items-center px-4 py-2 bg-gradient-to-r from-orange-500 to-amber-500 text-white text-sm font-medium rounded-lg hover:from-orange-600 hover:to-amber-600 transition-all shadow-md focus:outline-none focus:ring-2 focus:ring-orange-400"
                onClick={() => navigate("/custom-hamper")}
              >
                <Gift size={16} className="inline-block mr-2" strokeWidth={1.5} />
                Custom Hamper
              </button>

              {/* Customized Hamper Button - Mobile */}
              <button
                className="md:hidden flex items-center px-3 py-2 bg-gradient-to-r from-orange-500 to-amber-500 text-white text-sm font-medium rounded-lg hover:from-orange-600 hover:to-amber-600 transition-all shadow-md focus:outline-none focus:ring-2 focus:ring-orange-400"
                onClick={() => navigate("/custom-hamper")}
              >
                <Gift size={16} className="inline-block" strokeWidth={1.5} />
              </button>
                ...
                <div className="flex-1 overflow-y-auto">
                  ...
                  <div className="p-4 border-b border-purple-100">
                    <button
                      ...
                      className="w-full flex items-center justify-center px-4 py-3 bg-gradient-to-r from-orange-500 to-amber-500 text-white text-sm font-medium rounded-lg hover:from-orange-600 hover:to-amber-600 transition-all shadow-md"
                    >
                      <Gift size={18} className="mr-2" strokeWidth={1.5} />
                      Custom Hamper
                    </button>
                  </div>
